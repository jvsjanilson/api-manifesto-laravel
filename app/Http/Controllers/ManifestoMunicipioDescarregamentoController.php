...
class ManifestoMunicipioDescarregamentoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $find = ManifestoMunicipioDescarregamento::where('manifesto_id', $data['manifesto_id'])
        ...
        try {
            $create = ManifestoMunicipioDescarregamento::create($data);
            return response()->json(
                [
                    'inserted' => true,
                    'data' => $create
    ...
    {
        $reg = ManifestoMunicipioDescarregamento::find($id);
